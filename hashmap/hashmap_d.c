...
static /* __always_inline */ inline hashmap_bnode_t* __hashmap_end(const hashmap_t* _this);
static /* __always_inline */ inline hashmap_bnode_t* __hashmap_rend(const hashmap_t* _this);

static /* __always_inline */ inline bool __hashmap_bkt_only_l(const hashmap_t* _this)
{
    return _this->config.c.b_bkt_only_l;
}

static /* __always_inline */ inline bool __hashmap_bkt_only_r(const hashmap_t* _this)
{
    return _this->config.c.b_bkt_only_r;
}

static /* __always_inline */ inline bool __hashmap_bkt_l_to_r(const hashmap_t* _this)
{
    return _this->config.c.b_bkt_l_to_r;
}

static /* __always_inline */ inline hashmap_size_t __hashmap_size(const hashmap_t* _this)
{
    return _this->size;
}

static /* __always_inline */ inline hashmap_size_t _hashmap_size(const hashmap_t* _this)
{
...
static /* __always_inline */ inline hashmap_size_t __hashmap_capacity(const hashmap_t* _this)
{
    return _this->capacity;
}

static /* __always_inline */ inline hashmap_size_t _hashmap_capacity(const hashmap_t* _this)
{
    if (unlikely(is_null(_this)))
        return -1;
...
static /* __always_inline */ inline hashmap_bcount_t __hashmap_bucket_count(const hashmap_t* _this) /* TODO: return `hashmap_bcount_t` or others? */
{
    return _this->bucket_count;
}

static /* __always_inline */ inline hashmap_bcount_t _hashmap_bucket_count(const hashmap_t* _this)
{
    if (unlikely(is_null(_this)))
        return -1;
...
static /* __always_inline */ inline bucket_t* __hashmap_bucket_switch(hashmap_t* _this, bucket_t* bucket)
{
...
static /* __always_inline */ inline bool __hashmap_init_alloc(hashmap_t* _this)
{
...
static hashmap_size_t capacity_correct(hashmap_size_t capacity)
{
    uint8_t t = 0;
    hashmap_size_t ret;
