...
|------------------------|--------------------------|-------------------------|---------------------------|-------------------------|
| hashmap_reserve \| STL |   0.618 \|   1.022       |   1.067   \|   3.097    |   5.708   \|  11.300      |   0.163 \|   0.098      |
| hashmap         \| STL |   0.915 \|   1.375       |   1.291   \|   3.796    |   8.946   \|  14.642      |   0.156 \|   0.092      |
...
| Model                  | Insert 10^7 Elements(s)  | Find 10^8 Times(s)      | Remove 10^8 Times(s)      | Clear 10^7 Elements(s)  |
|------------------------|--------------------------|-------------------------|---------------------------|-------------------------|
| hashmap_reserve \| STL |   2.182 \|   2.486       |   7.778   \|  13.044    |   6.939   \|  10.027      |   0.467 \|   0.143      |
| hashmap         \| STL |   3.840 \|   5.445       |  10.248   \|  21.282    |   8.545   \|  16.650      |   0.400 \|   0.338      |
...
| Model                  | Insert 10^7 Elements(s)  | Find 10^8 Times(s)      | Remove 10^8 Times(s)      | Clear 10^7 Elements(s)  |
|------------------------|--------------------------|-------------------------|---------------------------|-------------------------|
| hashmap_reserve \| STL |   2.393 \|   2.278       |  12.675   \|  16.335    |  10.484   \|  12.949      |   0.921 \|   0.238      |
| hashmap         \| STL |   4.140 \|   4.008       |  14.653   \|  26.186    |  12.518   \|  22.116      |   0.887 \|   0.527      |
...
| Model                  | Insert 10^7 Elements(s)  | Find 10^8 Times(s)      | Remove 10^8 Times(s)      | Clear 10^7 Elements(s)  |
|------------------------|--------------------------|-------------------------|---------------------------|-------------------------|
| hashmap_reserve \| STL |   0.372 \|   0.190       |   0.384   \|   0.311    |   4.542   \|   4.753      |   0.095 \|   0.064      |
| hashmap         \| STL |   0.451 \|   0.317       |   0.487   \|   0.393    |   6.254   \|   5.547      |   0.094 \|   0.052      |
...
| Model                  | Insert 10^7 Elements(s)  | Find 10^8 Times(s)      | Remove 10^8 Times(s)      | Clear 10^7 Elements(s)  |
|------------------------|--------------------------|-------------------------|---------------------------|-------------------------|
| hashmap_reserve \| STL |   1.359 \|   1.007       |   5.467   \|   5.189    |   5.246   \|   4.941      |   0.258 \|   0.107      |
| hashmap         \| STL |   1.977 \|   3.121       |   6.751   \|   8.521    |   6.199   \|   7.609      |   0.230 \|   0.311      |
...
| Model                  | Insert 10^7 Elements(s)  | Find 10^8 Times(s)      | Remove 10^8 Times(s)      | Clear 10^7 Elements(s)  |
|------------------------|--------------------------|-------------------------|---------------------------|-------------------------|
| hashmap_reserve \| STL |   1.847 \|   1.110       |   9.614   \|   9.734    |   8.192   \|   9.056      |   0.539 \|   0.142      |
| hashmap         \| STL |   2.736 \|   2.633       |  10.925   \|  17.314    |   9.607   \|  15.939      |   0.520 \|   0.466      |
