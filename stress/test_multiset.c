...
{
    multiset_t* this = (multiset_t*)_this;
...
{
    multiset_t* this = (multiset_t*)_this;
    multiset_iterator_t it = cds->end(this);
...
{
    multiset_t* this = (multiset_t*)_this;
    multiset_iterator_t it = cds->begin(this);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
static stress_iterator_t next(void* _this, stress_iterator_t iterator)
{
    ...
    it.d = (multiset_data_t*)iterator.d;
    it = cds->next(this, it);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    multiset_t* this = (multiset_t*)_this;
    multiset_r_iterator_t it = cds->rend(this);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    multiset_t* this = (multiset_t*)_this;
    multiset_r_iterator_t it = cds->rbegin(this);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
static stress_iterator_t rnext(void* _this, stress_iterator_t r_iterator)
{
    ...
    it.d = (multiset_data_t*)r_iterator.d;
...
{
    multiset_t* this = (multiset_t*)_this;
    multiset_iterator_t it = cds->insert(this, data);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    multiset_t* this = (multiset_t*)_this;
    multiset_iterator_t it = cds->find(this, data);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    multiset_t* this = (multiset_t*)_this;
    multiset_iterator_t it = cds->lower_bound(this, data);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    multiset_t* this = (multiset_t*)_this;
    multiset_iterator_t it = cds->upper_bound(this, data);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
const class_stress_interface_t* class_stress_multiset_ins(void)
{
