...
{
    vector_t* this = (vector_t*)_this;
    vector_iterator_t it = cds->end(this);
...
{
    vector_t* this = (vector_t*)_this;
    vector_iterator_t it = cds->begin(this);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    vector_t* this = (vector_t*)_this;
    vector_r_iterator_t it = cds->rend(this);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    vector_t* this = (vector_t*)_this;
    vector_r_iterator_t it = cds->rbegin(this);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
static stress_iterator_t rnext(void* _this, stress_iterator_t r_iterator)
{
    ...
    it.d = (vector_data_t*)r_iterator.d;
...
{
    vector_t* this = (vector_t*)_this;
    vector_iterator_t it = cds->find(this, data);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    vector_t* this = (vector_t*)_this;
    vector_iterator_t it = cds->push_back(this, data);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    vector_t* this = (vector_t*)_this;
    vector_iterator_t it = cds->push_front(this, data);
    stress_iterator_t r = { .d = it.d, .ptr1 = NULL, .ptr2 = NULL, .ptr3 = NULL };
    return r;
}
...
{
    vector_t* this = (vector_t*)_this;
    vector_iterator_t itb, ite, it;
    itb.d = (vector_data_t*)iterator_begin.d;
    ite.d = (vector_data_t*)iterator_end.d;
...
const class_stress_slow_interface_t* class_stress_slow_vector_ins(void)
{
