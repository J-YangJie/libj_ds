/*
  Default Implementations Of Multiset Custom Operation Interfaces
...
/* __always_inline */ inline const class_multiset_ops_t* class_multiset_ops_string_ins(void)
{
    static const class_multiset_ops_t ins = {
